...
$_['text_express_title'] = 'Confirmar orden';
$_['text_vaulted_payment_method_name'] = '%s finalizando en %s, expira %s';
...
$_['text_saved_method'] = 'Elige una forma de pago guardada';
...
$_['text_cart'] = 'Cesta de la compra';
...
$_['entry_expires'] = 'Caduca en';
$_['entry_cvv'] = 'CVV';
$_['entry_remember_card_method'] = '¿Recuerda la tarjeta?';
$_['entry_remember_paypal_method'] = '¿Recuerda la cuenta de PayPal?';
...
// Error
$_['error_process_order'] = 'Se ha producido un error al procesar tu pedido. Póngase en contacto con el administrador de la tienda para obtener ayuda. ';
$_['error_alert_fields_empty'] = '¡Todos los campos están vacíos! Por favor rellena el formulario';
$_['error_alert_fields_invalid'] = 'Algunos campos no son válidos, comprueba tu información';
$_['error_alert_failed_token'] = 'Nuestro proveedor de pagos no reconoció la tarjeta. ¿Es válida la tarjeta? ';
$_['error_alert_failed_network'] = 'Se ha producido un error en la red, inténtalo de nuevo';
$_['error_alert_unknown'] = 'Se ha producido un error desconocido, si el problema persistiera, póngase en contacto con el servicio de asistencia';
